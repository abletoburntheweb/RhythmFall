...
static func build_theme() -> Theme:
	...
	var yellow_outline := theme.get_color("accent_yellow", "Palette")
	var fb_yellow_normal := btn_outline_normal.duplicate()
	fb_yellow_normal.border_color = yellow_outline
	var fb_yellow_hover := btn_outline_hover.duplicate()
	fb_yellow_hover.border_color = yellow_outline
	var fb_yellow_pressed := btn_outline_pressed.duplicate()
	fb_yellow_pressed.border_color = yellow_outline.darkened(0.2)
	var fb_yellow_disabled := btn_outline_disabled.duplicate()
	fb_yellow_disabled.border_color = yellow_outline.darkened(0.5)
	var fb_yellow_focus := btn_outline_focus.duplicate()
	fb_yellow_focus.border_color = yellow_outline
	theme.set_type_variation("FlatButtonYellow", "Button")
	theme.set_stylebox("normal", "FlatButtonYellow", fb_yellow_normal)
	theme.set_stylebox("hover", "FlatButtonYellow", fb_yellow_hover)
	theme.set_stylebox("pressed", "FlatButtonYellow", fb_yellow_pressed)
	theme.set_stylebox("disabled", "FlatButtonYellow", fb_yellow_disabled)
	theme.set_stylebox("focus", "FlatButtonYellow", fb_yellow_focus)
	theme.set_color("font_color", "FlatButtonYellow", text)
	...
	fb_orange_normal.border_color = orange_outline
	var fb_orange_hover := btn_outline_hover.duplicate()
	fb_orange_hover.border_color = orange_outline
	var fb_orange_pressed := btn_outline_pressed.duplicate()
	fb_orange_pressed.border_color = orange_outline.darkened(0.2)
	var fb_orange_disabled := btn_outline_disabled.duplicate()
	fb_orange_disabled.border_color = orange_outline.darkened(0.5)
	var fb_orange_focus := btn_outline_focus.duplicate()
	fb_orange_focus.border_color = orange_outline
	theme.set_type_variation("FlatButtonOrange", "Button")
	theme.set_stylebox("normal", "FlatButtonOrange", fb_orange_normal)
	theme.set_stylebox("hover", "FlatButtonOrange", fb_orange_hover)
	theme.set_stylebox("pressed", "FlatButtonOrange", fb_orange_pressed)
	theme.set_stylebox("disabled", "FlatButtonOrange", fb_orange_disabled)
	theme.set_stylebox("focus", "FlatButtonOrange", fb_orange_focus)
	theme.set_color("font_color", "FlatButtonOrange", text)
	theme.set_color("font_hover_color", "FlatButtonOrange", text)
	theme.set_color("font_pressed_color", "FlatButtonOrange", text)
	theme.set_color("font_disabled_color", "FlatButtonOrange", text.darkened(0.5))

	var green_outline := theme.get_color("accent_green", "Palette")
	var fb_green_normal := btn_outline_normal.duplicate()
	fb_green_normal.border_color = green_outline
	var fb_green_hover := btn_outline_hover.duplicate()
	fb_green_hover.border_color = green_outline
	var fb_green_pressed := btn_outline_pressed.duplicate()
	fb_green_pressed.border_color = green_outline.darkened(0.2)
	var fb_green_disabled := btn_outline_disabled.duplicate()
	fb_green_disabled.border_color = green_outline.darkened(0.5)
	var fb_green_focus := btn_outline_focus.duplicate()
	fb_green_focus.border_color = green_outline
	theme.set_type_variation("FlatButtonGreen", "Button")
	theme.set_stylebox("normal", "FlatButtonGreen", fb_green_normal)
	theme.set_stylebox("hover", "FlatButtonGreen", fb_green_hover)
	theme.set_stylebox("pressed", "FlatButtonGreen", fb_green_pressed)
	theme.set_stylebox("disabled", "FlatButtonGreen", fb_green_disabled)
	theme.set_stylebox("focus", "FlatButtonGreen", fb_green_focus)
	theme.set_color("font_color", "FlatButtonGreen", text)
	theme.set_color("font_hover_color", "FlatButtonGreen", text)
	theme.set_color("font_pressed_color", "FlatButtonGreen", text)
	theme.set_color("font_disabled_color", "FlatButtonGreen", text.darkened(0.5))
	...
	var fb_res_hover := _make_button_hover_box(res_outline)
	...
	var fb_menu_song_hover := _make_button_hover_box(menu_song_outline)
	...
	var fb_menu_ach_hover := _make_button_hover_box(menu_ach_outline)
	...
	var danger := theme.get_color("danger", "Palette")
	var subtle_bg := panel_bg.lightened(0.03)
	var win_panel_default := _make_button_box(panel_bg, panel_border, true, 1)
	var win_panel_primary := _make_button_box(panel_bg, primary, true, 2)
	var win_panel_danger := _make_button_box(panel_bg, danger, true, 2)
	var win_panel_subtle := _make_button_box(subtle_bg, panel_border, true, 1)
	theme.set_stylebox("panel", "Window", win_panel_default)
	theme.set_color("title_color", "Window", text)
	var acc_panel_primary := _make_button_box(subtle_bg, primary, true, 2)
	var acc_panel_danger := _make_button_box(subtle_bg, danger, true, 2)
	var acc_panel_subtle := _make_button_box(subtle_bg, panel_border, true, 2)
	var acc_panel_success := _make_button_box(subtle_bg, theme.get_color("accent_mint", "Palette"), true, 2)
	var acc_panel_warning := _make_button_box(subtle_bg, theme.get_color("accent_orange", "Palette"), true, 2)
	var acc_panel_info := _make_button_box(subtle_bg, theme.get_color("accent_sky", "Palette"), true, 2)
	acc_panel_primary.shadow_size = 0
	acc_panel_primary.shadow_color = Color(0, 0, 0, 0)
	acc_panel_danger.shadow_size = 0
	acc_panel_danger.shadow_color = Color(0, 0, 0, 0)
	acc_panel_subtle.shadow_size = 0
	acc_panel_subtle.shadow_color = Color(0, 0, 0, 0)
	acc_panel_success.shadow_size = 0
	acc_panel_success.shadow_color = Color(0, 0, 0, 0)
	acc_panel_warning.shadow_size = 0
	acc_panel_warning.shadow_color = Color(0, 0, 0, 0)
	acc_panel_info.shadow_size = 0
	acc_panel_info.shadow_color = Color(0, 0, 0, 0)
	theme.set_type_variation("AcceptDialogPrimary", "AcceptDialog")
	theme.set_stylebox("panel", "AcceptDialogPrimary", acc_panel_primary)
	theme.set_color("title_color", "AcceptDialogPrimary", text)
	theme.set_type_variation("AcceptDialogDanger", "AcceptDialog")
	theme.set_stylebox("panel", "AcceptDialogDanger", acc_panel_danger)
	theme.set_color("title_color", "AcceptDialogDanger", text)
	theme.set_type_variation("AcceptDialogSubtle", "AcceptDialog")
	theme.set_stylebox("panel", "AcceptDialogSubtle", acc_panel_subtle)
	theme.set_color("title_color", "AcceptDialogSubtle", text)
	theme.set_type_variation("AcceptDialogSuccess", "AcceptDialog")
	theme.set_stylebox("panel", "AcceptDialogSuccess", acc_panel_success)
	theme.set_color("title_color", "AcceptDialogSuccess", text)
	theme.set_type_variation("AcceptDialogWarning", "AcceptDialog")
	theme.set_stylebox("panel", "AcceptDialogWarning", acc_panel_warning)
	theme.set_color("title_color", "AcceptDialogWarning", text)
	theme.set_type_variation("AcceptDialogInfo", "AcceptDialog")
	theme.set_stylebox("panel", "AcceptDialogInfo", acc_panel_info)
	theme.set_color("title_color", "AcceptDialogInfo", text)
	theme.set_type_variation("ConfirmationDialogPrimary", "ConfirmationDialog")
	theme.set_stylebox("panel", "ConfirmationDialogPrimary", acc_panel_primary)
	theme.set_color("title_color", "ConfirmationDialogPrimary", text)
	theme.set_type_variation("ConfirmationDialogDanger", "ConfirmationDialog")
	theme.set_stylebox("panel", "ConfirmationDialogDanger", acc_panel_danger)
	theme.set_color("title_color", "ConfirmationDialogDanger", text)
	theme.set_type_variation("ConfirmationDialogSubtle", "ConfirmationDialog")
	theme.set_stylebox("panel", "ConfirmationDialogSubtle", acc_panel_subtle)
	theme.set_color("title_color", "ConfirmationDialogSubtle", text)
	theme.set_type_variation("ConfirmationDialogSuccess", "ConfirmationDialog")
	theme.set_stylebox("panel", "ConfirmationDialogSuccess", acc_panel_success)
	theme.set_color("title_color", "ConfirmationDialogSuccess", text)
	theme.set_type_variation("ConfirmationDialogWarning", "ConfirmationDialog")
	theme.set_stylebox("panel", "ConfirmationDialogWarning", acc_panel_warning)
	theme.set_color("title_color", "ConfirmationDialogWarning", text)
	theme.set_type_variation("ConfirmationDialogInfo", "ConfirmationDialog")
	theme.set_stylebox("panel", "ConfirmationDialogInfo", acc_panel_info)
	theme.set_color("title_color", "ConfirmationDialogInfo", text)

	theme.set_type_variation("FileDialogPrimary", "FileDialog")
	theme.set_stylebox("panel", "FileDialogPrimary", acc_panel_primary)
	theme.set_color("title_color", "FileDialogPrimary", text)
	theme.set_type_variation("FileDialogDanger", "FileDialog")
	theme.set_stylebox("panel", "FileDialogDanger", acc_panel_danger)
	theme.set_color("title_color", "FileDialogDanger", text)
	theme.set_type_variation("FileDialogSubtle", "FileDialog")
	theme.set_stylebox("panel", "FileDialogSubtle", acc_panel_subtle)
	theme.set_color("title_color", "FileDialogSubtle", text)
	theme.set_type_variation("FileDialogSuccess", "FileDialog")
	theme.set_stylebox("panel", "FileDialogSuccess", acc_panel_success)
	theme.set_color("title_color", "FileDialogSuccess", text)
	theme.set_type_variation("FileDialogWarning", "FileDialog")
	theme.set_stylebox("panel", "FileDialogWarning", acc_panel_warning)
	theme.set_color("title_color", "FileDialogWarning", text)
	theme.set_type_variation("FileDialogInfo", "FileDialog")
	theme.set_stylebox("panel", "FileDialogInfo", acc_panel_info)
	theme.set_color("title_color", "FileDialogInfo", text)
